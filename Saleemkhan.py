...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕Saleem▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕B4 M4▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
...
\033[1;91m☞ Auther     : Saleem khan502
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WhatsApp Num 03162089494✓')
	    psb('WellCome To Saleem-khan')
	    psb('Congratulations B4_BALOCH Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ 14102014✓')
	    psb('🔓Password ☆ 14102014✓')
	    psb('Subscrib My Youtube Channel SALEEM-KHAN✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/SALEEM-KHAN && python2 B4.py')
	elif bm =='3':
